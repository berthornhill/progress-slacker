...
class MemeCanvas extends React.Component {
  ...
  render() {
    ...
    const aaTags = tags["601c540100fa3dd36b44a7ae"];
    let aaMemes = allMemes.map((meme, i) => {
      debugger;
      if (aaTags.memes.includes(meme._id)) {
        debugger;
        return (
          <img
            src={meme.img}
        ...
        <div className="select-img">
          ...
          <div className="img-table">
            <h1 className="table-header">
              ...
              <button
                onClick={() =>
                  this.props.displayAATemps(
                    this.props.tags["601c540100fa3dd36b44a7ae"]
                  )
                }
              >
                a/A
              </button>
              <button onClick={() => this.props.fetchTemplates()}>All</button>
            </h1>
            {aaMemes}
          </div>
        </div>
